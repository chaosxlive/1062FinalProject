...
public class ClientCode extends java.lang.Thread {
	...
	private void initialize() {
		...
		frmClient.setTitle("Client - " + name);
		frmClient.setBounds(100, 100, 450, 300);
		frmClient.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		frmClient.getContentPane().setLayout(null);
		frmClient.addComponentListener(new ComponentListener() {
			...
			public void componentResized(ComponentEvent e) {
				if(frmClient.getWidth()>1920) {
					frmClient.setSize(1920, frmClient.getHeight());
				}
				if (frmClient.getHeight()>1080) {
					frmClient.setSize(frmClient.getWidth(), 1080);
				}
				if(frmClient.getWidth()<450) {
					frmClient.setSize(450, frmClient.getHeight());
				}
				if (frmClient.getHeight()<300) {
					frmClient.setSize(frmClient.getWidth(), 300);
				}
				panel_1.setSize(frmClient.getSize());
				lblNewLabel.setSize(frmClient.getSize());
		...
		emoji01.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				addDoc(name + ": ");
				addDoc(new ImageIcon(ClientCode.class.getResource("/together/image/ImoSv_1.png")));
		...
		//--
		//e2
		emoji02.setIcon(new ImageIcon(ClientCode.class.getResource("/together/image/Imo_2.png")));
		...
		emoji02.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				addDoc(name + ": ");
				addDoc(new ImageIcon(ClientCode.class.getResource("/together/image/ImoSv_2.png")));
		...
		//--
		//e3
		emoji03.setIcon(new ImageIcon(ClientCode.class.getResource("/together/image/Imo_3.png")));
		...
		emoji03.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				addDoc(name + ": ");
				addDoc(new ImageIcon(ClientCode.class.getResource("/together/image/ImoSv_3.png")));
		...
		//--
		//e4
		emoji04.setIcon(new ImageIcon(ClientCode.class.getResource("/together/image/Imo_4.png")));
		...
		emoji04.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				addDoc(name + ": ");
				addDoc(new ImageIcon(ClientCode.class.getResource("/together/image/ImoSv_4.png")));
		...
		//--
		//e5
		emoji05.setIcon(new ImageIcon(ClientCode.class.getResource("/together/image/Imo_5.png")));
		...
		emoji05.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				addDoc(name + ": ");
				addDoc(new ImageIcon(ClientCode.class.getResource("/together/image/ImoSv_5.png")));
		...
		//--
		//e6
		emoji06.setIcon(new ImageIcon(ClientCode.class.getResource("/together/image/Imo_6.png")));
		...
		emoji06.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				addDoc(name + ": ");
				addDoc(new ImageIcon(ClientCode.class.getResource("/together/image/ImoSv_6.png")));
		...
		//--
		//e7
		emoji07.setIcon(new ImageIcon(ClientCode.class.getResource("/together/image/Imo_7.png")));
		...
		emoji07.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				addDoc(name + ": ");
				addDoc(new ImageIcon(ClientCode.class.getResource("/together/image/ImoSv_7.png")));
		...
		//--
		//e8
		emoji08.setIcon(new ImageIcon(ClientCode.class.getResource("/together/image/Imo_8.png")));
		...
		emoji08.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				addDoc(name + ": ");
				addDoc(new ImageIcon(ClientCode.class.getResource("/together/image/ImoSv_8.png")));
		...
		//--
		//e9
		emoji09.setIcon(new ImageIcon(ClientCode.class.getResource("/together/image/Imo_9.png")));
		...
		emoji09.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				addDoc(name + ": ");
				addDoc(new ImageIcon(ClientCode.class.getResource("/together/image/ImoSv_9.png")));
		...
		//--
		//e10
		emoji10.setIcon(new ImageIcon(ClientCode.class.getResource("/together/image/Imo_10.png")));
		...
		emoji10.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				addDoc(name + ": ");
				addDoc(new ImageIcon(ClientCode.class.getResource("/together/image/ImoSv_10.png")));
		...
		//--
		//e11
		emoji11.setIcon(new ImageIcon(ClientCode.class.getResource("/together/image/Imo_11.png")));
		...
		emoji11.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				addDoc(name + ": ");
				addDoc(new ImageIcon(ClientCode.class.getResource("/together/image/ImoSv_11.png")));
		...
		//--
		//e12
		emoji12.setIcon(new ImageIcon(ClientCode.class.getResource("/together/image/Imo_12.png")));
		...
		emoji12.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				addDoc(name + ": ");
				addDoc(new ImageIcon(ClientCode.class.getResource("/together/image/ImoSv_12.png")));
		...
		shockbtn.setIcon(new ImageIcon(ClientCode.class.getResource("/together/image/DingDong_30.png")));
	    ...
	    label.addMouseListener(new MouseListener() {
			...
			public void mouseClicked(MouseEvent e) {
				if(!isOpened) {
					...
					photoFrame.setLocation(frmClient.getX() + frmClient.getWidth(), frmClient.getY());
	...
	private void refreshNodes() {
		...
		panel.setBounds(0, 0, frmClient.getWidth()-6, frmClient.getHeight()-28);
	...
	private int port;
	public ClientCode(String ip, int port, String name) {
		this.name = name;
		this.port = port;
		initialize();
	...
	public void run() {
		try {
			if(socket!=null) {
				...
				addDoc("Connection Error! Please try again later.\n");
				addDoc("This program will automatally close in 3 seconds.\n");
				textPane.setCaretPosition(textPane.getDocument().getLength());
				Thread.sleep(3000);
				frmClient.dispose();
			}
	...
	public void runFCmd(String text) throws IOException, BadLocationException {
		if(text.equals("/exit")) {
			...
			if(!frmClient.isFocused()) {
				boolean isMaxed = (frmClient.getExtendedState() == JFrame.MAXIMIZED_BOTH) ? true : false;
				frmClient.setExtendedState(JFrame.ICONIFIED);
				frmClient.setExtendedState((isMaxed) ? JFrame.MAXIMIZED_BOTH : JFrame.NORMAL);
			}
			try {
				resetSe();
			...
			frameshake.startShake(frmClient);
		}
	}
}
